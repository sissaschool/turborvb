...
!     call dgemm('N','T',N,N,2*k,alpha,ab,N,ab(1,2*k+1),N,beta,C,LDC)
      call dgemm('N','T',N,N,k,alpha,a,lda,b,ldb,beta,C,LDC)
      call dgemm('N','T',N,N,k,-alpha,b,ldb,a,lda,1.d0,C,LDC)
      else
*     C := alpha*A^T*B - alpha*B^T*A + beta*C,
!     allocate(ab(4*k,N))
...
!     call dgemm('T','N',N,N,2*k,alpha,ab,4*k,ab(2*k+1,1),4*k
!    *,beta,C,LDC)
      call dgemm('T','N',N,N,k,alpha,a,lda,b,ldb,beta,C,LDC)
      call dgemm('T','N',N,N,k,-alpha,b,ldb,a,lda,1.d0,C,LDC)
      endif
