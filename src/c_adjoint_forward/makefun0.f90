...
!###########################################################
    ...
    SUBROUTINE makefun0 (iopt,indt,typec,indpar,indorb,indshell,nelskip,z,dd,zeta,r,rmu,distp,iflagnorm_unused,cr)
         ...
         real*8 z(nelskip,0:*),dd(*),zeta(*),rmu(3,0:0)        ,r(0:0)                                                   ,distp(0:0,20),peff,fun,fun0,fun2,rp1,rp2,rp3,rp4,rp5,rp6,rp7,rp8 ,dd1,dd2,dd3,dd4,dd5,c,cr,funp,fun2p                           ,peff2,arg,c0,c1,cost,zv(6),yv(6),xv(6),r2,r4,r6 ! up to i
!
...
!        endif
        indpar=indpar+1
        indshell=indshellp
      case(81) ! derivative of bump gaussian
