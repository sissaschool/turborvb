...
# Kosuke Nakano created on 26 Mar. 2019 to avoid reading
# fort.21 repeatedly. When you put a negative number for
# Initial bin for averages $3, the new function works.
# The flag_read_once in forcevmc.sh is set "True" in this case.

# Kosuke Nakano updated on 6 Nov. 2020 to remove pulay_ratio
# option. Indeed, one can omit pulay_ratio input, in this case,
# pulay_ratio is set 1 automatically.
#
# how to use
# forcefn_kpoints_parallel.sh  bins correcting_factor initials pulay_ratio number_of_processors
# or
# forcefn_kpoints_parallel.sh  bins correcting_factor initials number_of_processors
...
echo "--------------------------------------------------------------------------"
echo "The elapse time of forcefn_kpoints_parallel.sh is $time [sec] by ${num_cpu_max} cores"
echo "--------------------------------------------------------------------------"
exit
